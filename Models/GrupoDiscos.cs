...
public class GrupoDiscos
    {
        ...
        public static void InicializarDiscos()
        {
            ...
            Disco HarrysHouse = new Disco("HarrysHouse","Harry styles", "Jose", "Pop", temasHarrysHouse, 1, "fotos/descargapostaH.jpg");
            ...
            Disco Espresso = new Disco("Espresso","Sabrina Carpenter", "Pablo", "Pop", temasEspresso, 2, "fotos/descargapostaS.jpg");
            ...
            Disco Sour = new Disco("Sour","Olivia Rodrigo", "Pipi", "Pop Rock", temasSour, 3, "fotos/descargapostaO.jpg");
            agregarDisco(3, Sour);
            ...
            Disco TakeMeHome = new Disco("TakeMeHome", "One Direction", "Mauro", "Pop", temasTakeMeHome, 4,"fotos/descargaposta1D.jpg");
            ...
            Disco Cupido = new Disco("Cupido", "TINI", "Merlo", "Latin Pop", temasCupido, 5, "fotos/descargapostaT.jpg");
            ...
            Disco Walls = new Disco("Walls","Louis Tomlinson", "Martin", "Rock", temasWalls, 6, "fotos/descargapostaL.jpg");
            ...
            Disco Positions = new Disco("Positions", "Ariana Grande", "Benson", "Pop/R&B", temasPositions, 7, "fotos/descargapostaA.jpg");
            ...
            Disco ShawnMendes = new Disco("Shawn Mendes", "Shawn Mendes", "Camilla", "Pop", temasShawnMendes, 8, "fotos/descargapostaSH.jpg");
            ...
            Disco Obsesionario = new Disco("Obsesionario","Tan Biónica", "Federico", "Pop Rock", temasObsesionario, 9, "fotos/descargapostaTB.jpg");
            ...
            Disco BalasPerdidas = new Disco("Balas Perdidas","Morat", "Carla", "Pop Rock", temasBalasPerdidas, 10, "fotos/descargapostaM.jpg");
            ...
            Disco MP3 = new Disco("MP3","Emilia Mernes", "Mario", "Pop Urbano", temasMP3, 11, "fotos/descargapostaE.jpg");
            agregarDisco(11, MP3);
            ...
            Disco Ameri = new Disco("AMERI","Duki", "Lola", "Trap", temasAmeri, 12, "fotos/descargapostaD.jpg");
