...
public class GrupoDiscos
    {
        ...
        public static void InicializarDiscos()
        {
            ...
            Disco Espresso = new Disco("Espresso","Sabrina Carpenter", "Pablo", "Pop", temasEspresso, 2, "fotos/sabrina.jfif");
            ...
            Disco Sour = new Disco("Sour","Olivia Rodrigo", "Pipi", "Pop Rock", temasSour, 3, "fotos/olivia.jfif");
            agregarDisco(3, Sour);
            ...
            Disco TakeMeHome = new Disco("TakeMeHome", "One Direction", "Mauro", "Pop", temasTakeMeHome, 4,"fotos/1d.jfif");
            ...
            Disco Cupido = new Disco("Cupido", "TINI", "Merlo", "Latin Pop", temasCupido, 5, "fotos/tini.jfif");
            ...
            Disco Walls = new Disco("Walls","Louis Tomlinson", "Martin", "Rock", temasWalls, 6, "fotos/louis.jfif");
            ...
            Disco Positions = new Disco("Positions", "Ariana Grande", "Benson", "Pop/R&B", temasPositions, 7, "fotos/ariana.jfif");
            ...
            Disco ShawnMendes = new Disco("Shawn Mendes", "Shawn Mendes", "Camilla", "Pop", temasShawnMendes, 8, "fotos/shawn.jfif");
            ...
            Disco Obsesionario = new Disco("Obsesionario","Tan Biónica", "Federico", "Pop Rock", temasObsesionario, 9, "fotos/tan bionica.jfif");
            ...
            Disco BalasPerdidas = new Disco("Balas Perdidas","Morat", "Carla", "Pop Rock", temasBalasPerdidas, 10, "fotos/morat.jfif");
            ...
            Disco MP3 = new Disco("MP3","Emilia Mernes", "Mario", "Pop Urbano", temasMP3, 11, "fotos/emilia.jfif");
            agregarDisco(11, MP3);
            ...
            Disco Ameri = new Disco("AMERI","Duki", "Lola", "Trap", temasAmeri, 12, "fotos/duki.jfif");
